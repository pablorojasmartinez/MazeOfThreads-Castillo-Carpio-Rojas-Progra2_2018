...
//        this.image = new Image(new FileInputStream("src/Assets/pac1.png"));
    ...
    public SmartCharacter(Item sharedLocation){
    ...
    public void changeSpeed() {
        ...
        for (int i = 0; i < this.currentBrick.getBrickArray().size(); i++) {
            if (this.currentBrick.getBrickType() == "fruta") {
                speed = 5;
            }
        }
    }
        ...
        public void run() {
            while (crash2) {
                ...
                try {
                    ...
                    //System.err.println("Cont:" + cunt + " Sleep:" + sleep + "State:" + state);
        ...
        while (flag2) {
            ...
            if (searchDirection(direction)) {
                try {
                    ...
                    Logger.getLogger(SmartCharacter.class
